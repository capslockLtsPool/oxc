...
unlocked to sign the OXCoin-Qt.app bundle.
...
allowing somebody to distribute a OXCoin-Qt.app or oxcoin-qt-setup.exe with a valid
...
that the oxcoin-qt.exe file inside the installer had not been tampered with.
