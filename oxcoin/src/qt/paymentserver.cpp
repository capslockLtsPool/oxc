...
const QString BITCOIN_IPC_PREFIX("oxcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click oxcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start oxcoin: click-to-pay handler");
    else
...
{
    // clicking on oxcoin: URLs creates FileOpen events on the Mac:
